export const TEAMS = [
  "MEX Mexico", "RSA South Africa", "KOR Korea del Sur", "CZE Czechia", "BRA Brazil", "MAR Morocco", "HAI Haiti", "SCO Scotland", 
  "GER Germany", "CUW Curacao", "CIV Cote dIvoire", "ECU Ecuador", "BEL Belgium", "EGY Egypt", "IRN Iran", "NZL New Zealand", 
  "FRA France", "SEN Senegal", "IRQ Iraq", "NOR Norway", "POR Portugal", "COD Congo DR", "UZB Uzbekistan", "COL Colombia", 
  "CAN Canada", "BIH Bosnia-Herzegovina", "QAT Qatar", "SUI Switzerland", "USA USA", "PAR Paraguay", "AUS Australia", 
  "TUR Turkiye", "NED Netherlands", "JPN Japan", "SWE Sweden", "TUN Tunisia", "ESP Spain", "CPV Cabo Verde", "KSA Saudi Arabia", "URU Uruguay", 
  "ARG Argentina", "ALG Algeria", "AUT Austria", "JOR Jordan", "ENG England", "CRO Croatia", "GHA Ghana", "PAN Panama"
];
